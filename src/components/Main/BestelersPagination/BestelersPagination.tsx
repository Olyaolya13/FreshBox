  ...
  return (
    <div className="bestsekers-pagination">
      ...
      <div className="bestsekers-pagination__cards">
        <ShopCard title={titles[firstIndex]} count="5" image={images[firstIndex]} />
        <ShopCard title={titles[secondIndex]} count="5" image={images[secondIndex]} />
        <ShopCard title={titles[thirdIndex]} count="5" image={images[thirdIndex]} />
        <ShopCard title={titles[forthIndex]} count="5" image={images[forthIndex]} />
      </div>
